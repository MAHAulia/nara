...
ARCH=$(uname -m)
DOWNLOAD_URL=""
INSTALL_DIR="/usr/local/Nara"
EXECUTABLE_NAME="Nara"

# Check the platform and set the download URL accordingly
if [ "$PLATFORM" == "Darwin" ]; then
    echo "macOS Platform"
    DOWNLOAD_URL="https://github.com/MAHAulia/nara/releases/download/v0.0.1/nara-macOS"
elif [ "$PLATFORM" == "Linux" ]; then
    if [ "$ARCH" == "x86_64" ]; then
        echo "Linux x86_64 Platform"
        DOWNLOAD_URL="https://github.com/MAHAulia/nara/releases/download/v0.0.1/nara-linux-64"
    elif [ "$ARCH" == "i686" ]; then
        echo "Linux i686 Platform"
        DOWNLOAD_URL="https://github.com/MAHAulia/nara/releases/download/v0.0.1/nara-linux-32"
    else
